...
class MutualFriendSerializer(serializers.Serializer):
    ...
    friends = serializers.ListField(child=serializers.CharField(), read_only=True)
    ...
    def create(self, validated_data):
        ...
        final = models.Person.objects.filter(id__in=mutuals_ids, has_died=False, eye_color='brown').values_list('id', flat=True)
